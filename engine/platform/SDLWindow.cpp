...
namespace vva::gfx::GL {
    ...
    auto SDLWindow::Initialize(int _width, int _height, std::string _title, RenderBackend backend) -> bool {
        ...
        switch (m_backend) {
            case RenderBackend::OpenGL:
                vva_log_error("the OpenGL backend has been removed; use RenderBackend::Vulkan");
                break;
    ...
    auto SDLWindow::Close() -> void {
        const bool hadOpenResources = m_window != nullptr;
    ...
    auto SDLWindow::SwapBuffers() -> void {
        // Vulkan presents through the swapchain; nothing to do here.
    }
